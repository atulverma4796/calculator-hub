    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <CalcInput value={pct1} onChange={setPct1} className="w-20 text-center text-sm font-bold text-pink-700 bg-pink-50 border border-pink-200 rounded-lg px-2 py-2 focus:ring-2 focus:ring-pink-500 focus:border-transparent" />
          <VoiceInputButton onResult={(v) => setPct1(v)} />
          <span className="text-sm text-gray-600 dark:text-gray-400">% of</span>
          <CalcInput value={num1} onChange={setNum1} className="w-28 text-center text-sm font-bold text-pink-700 bg-pink-50 border border-pink-200 rounded-lg px-2 py-2 focus:ring-2 focus:ring-pink-500 focus:border-transparent" />
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <CalcInput value={num2a} onChange={setNum2a} className="w-24 text-center text-sm font-bold text-pink-700 bg-pink-50 border border-pink-200 rounded-lg px-2 py-2 focus:ring-2 focus:ring-pink-500 focus:border-transparent" />
          <VoiceInputButton onResult={(v) => setNum2a(v)} />
          <span className="text-sm text-gray-600 dark:text-gray-400">is what % of</span>
          <CalcInput value={num2b} onChange={setNum2b} className="w-24 text-center text-sm font-bold text-pink-700 bg-pink-50 border border-pink-200 rounded-lg px-2 py-2 focus:ring-2 focus:ring-pink-500 focus:border-transparent" />
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <CalcInput value={num3a} onChange={setNum3a} className="w-24 text-center text-sm font-bold text-pink-700 bg-pink-50 border border-pink-200 rounded-lg px-2 py-2 focus:ring-2 focus:ring-pink-500 focus:border-transparent" />
          <VoiceInputButton onResult={(v) => setNum3a(v)} />
          <span className="text-sm text-gray-600 dark:text-gray-400">to</span>
          <CalcInput value={num3b} onChange={setNum3b} className="w-24 text-center text-sm font-bold text-pink-700 bg-pink-50 border border-pink-200 rounded-lg px-2 py-2 focus:ring-2 focus:ring-pink-500 focus:border-transparent" />
