        ...
        <div className="lg:col-span-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <CalcInput value={currentAge} onChange={setCurrentAge} min={18} max={70} className="w-full text-center text-sm font-bold text-fuchsia-700 bg-fuchsia-50 border border-fuchsia-200 rounded-lg px-3 py-2" />
            ...
            <div>
              ...
              <CalcInput value={retireAge} onChange={setRetireAge} min={currentAge + 1} max={80} className="w-full text-center text-sm font-bold text-fuchsia-700 bg-fuchsia-50 border border-fuchsia-200 rounded-lg px-3 py-2" />
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <CalcInput value={currentSavings} onChange={setCurrentSavings} className="w-32 text-right text-sm font-bold text-fuchsia-700 bg-fuchsia-50 border border-fuchsia-200 rounded-lg px-3 py-1.5" />
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-1">
                <span className="text-xs text-gray-400 dark:text-gray-500">{currency.symbol}</span>
                <CalcInput value={monthlySaving} onChange={setMonthlySaving} className="w-28 text-right text-sm font-bold text-fuchsia-700 bg-fuchsia-50 border border-fuchsia-200 rounded-lg px-3 py-1.5" />
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-1">
                <CalcInput value={returnRate} onChange={setReturnRate} step={0.5} className="w-20 text-right text-sm font-bold text-fuchsia-700 bg-fuchsia-50 border border-fuchsia-200 rounded-lg px-3 py-1.5" />
