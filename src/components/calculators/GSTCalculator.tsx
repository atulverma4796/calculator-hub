      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <div className="relative flex-1">
              ...
              <CalcInput value={amount} onChange={setAmount} className="w-full pl-8 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl text-lg font-bold text-gray-800 dark:text-white dark:bg-gray-800 focus:ring-2 focus:ring-violet-500 focus:border-transparent" />
            </div>
        ...
        <div>
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <CalcInput value={taxRate} onChange={setTaxRate} step={0.5} min={0} max={100} className="w-20 text-center text-sm font-bold text-violet-700 bg-violet-50 border border-violet-200 rounded-lg px-2 py-1 focus:ring-2 focus:ring-violet-500" />
