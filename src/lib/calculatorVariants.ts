...
export const CALCULATOR_VARIANTS: CalculatorVariant[] = [
  ...
  },
  {
    ...
    title: "Free UK Income Tax Calculator 2026/27",
    description: "Calculate your 2026/27 UK income tax, National Insurance, and take-home pay. PAYE bands, personal allowance, and NI rates. Free, instant, no signup.",
    ...
    intro: "UK income tax for the 2026/27 tax year (6 April 2026 – 5 April 2027) uses a progressive system with bands: Personal Allowance (0%), Basic Rate (20%), Higher Rate (40%), and Additional Rate (45%). National Insurance is charged on top. Tax bands remain frozen at 2025/26 levels — meaning more earners are pulled into the 40% band each year through fiscal drag. This calculator shows your combined Income Tax and NI deductions and your final take-home pay.",
    tips: [
    ...
    faqs: [
      { q: "What is the UK personal allowance for 2026/27?", a: "£12,570 per year — this amount is completely tax-free. However, it reduces by £1 for every £2 earned over £100,000, meaning it reaches zero at £125,140. The Personal Allowance has been frozen at this level since 2021/22." },
      { q: "When does the 40% tax band start in 2026/27?", a: "The Higher Rate (40%) starts at taxable income above £50,270 — the same threshold as 2025/26. Combined with the £12,570 Personal Allowance, you start paying 40% on earnings above £50,270 in total income." },
      { q: "How much tax do I pay on a £50,000 salary?", a: "On £50,000 for 2026/27: Income Tax is £7,486 (20% on £37,430), and National Insurance is approximately £3,016 (8% on income between £12,570 and £50,270). Total deductions ≈ £10,502, leaving take-home pay of about £39,498." },
      { q: "How much tax do I pay on a £70,000 salary?", a: "On £70,000: Income Tax is approximately £15,432, and NI is approximately £3,410. Total ≈ £18,842, leaving take-home around £51,158. You pay 40% on income above £50,270, but only 2% NI on that portion." },
      { q: "What's the difference between Income Tax and National Insurance?", a: "Income Tax is paid on most income (salary, self-employment, rental, dividends) and funds general government spending. National Insurance is separate and funds the State Pension and NHS — it applies to earned income only (not pensions or rental income). They use different thresholds and rates." },
      { q: "Are tax bands changing in 2026/27?", a: "No — the Personal Allowance (£12,570), Higher Rate threshold (£50,270), and Additional Rate threshold (£125,140) remain frozen, as they have been since 2021. This creates fiscal drag: as wages rise with inflation, more income is pulled into higher tax bands." },
      { q: "How do I calculate my take-home pay?", a: "Take-home = Gross Salary − Income Tax − National Insurance − Pension contributions − Student Loan repayments. This calculator shows tax + NI; subtract those plus any pension/student loan deductions from gross pay for your net monthly amount." },
      { q: "Do I pay tax on my entire salary or just income above £12,570?", a: "Only above £12,570. The first £12,570 is your Personal Allowance — completely tax-free. You then pay 20% on the next £37,700 (up to £50,270), 40% on income between £50,270 and £125,140, and 45% above that." },
      { q: "What is fiscal drag and how does it affect me?", a: "Fiscal drag happens when tax thresholds stay frozen while wages rise with inflation. Even if you get a pay raise, you may end up paying a higher effective tax rate. Since 2021, frozen UK thresholds have quietly increased the tax burden — the OBR estimates millions more taxpayers will be in the 40% band by 2028." },
      { q: "Are bonuses taxed differently from salary?", a: "No — bonuses are taxed at your marginal rate (the rate on your highest income band). However, bonuses can temporarily push you into a higher band for that month, causing PAYE to over-deduct. HMRC reconciles this at year-end so your annual tax is correct." },
    ],
  },
  ...
  // ── Timezone Variants ─────────────────────────────
  {
    ...
    title: "EST to IST Time Converter (Free)",
    description: "Convert EST to IST instantly. IST is 10.5 hours ahead of EST (9.5 during US DST). Plan US–India meetings, calls, and deadlines. Free, no signup.",
    ...
    intro: "Convert between Eastern Standard Time (EST/EDT, UTC-5/-4) and India Standard Time (IST, UTC+5:30). The difference is 10.5 hours during US winter (EST) and 9.5 hours during US summer (EDT, mid-March to early November). This is one of the most-searched timezone conversions in the world because of how tightly US East Coast offices coordinate with Indian engineering, support, and BPO teams — billions of dollars of work flow across this exact time gap every day. Use this converter to schedule overlap windows, set meeting times, plan handoffs between night and day shifts, and avoid the classic mistake of booking a 9 AM Bangalore call that lands at 11:30 PM in New York.",
    tips: [
      "IST is 10.5 hours ahead of EST (Nov–Mar) and 9.5 hours ahead during EDT (Mar–Nov)",
      "India does NOT observe daylight saving — IST is constant year-round at UTC+5:30",
      "Best overlap for US East Coast – India meetings: 8:30–10 AM EST = 7–8:30 PM IST",
      "Reverse overlap: 8–9:30 PM EST = 6:30–8 AM IST (next day) — convenient for late-evening US calls",
      "US DST starts on the 2nd Sunday of March and ends on the 1st Sunday of November — the gap drops to 9.5 hours during this window",
      "When the US shifts to daylight time, calls that were 9 AM IST → 11:30 PM EST yesterday now happen at 10:30 PM EST — easy to miss",
      "Bangalore, Mumbai, Delhi, Hyderabad, Chennai, Pune, Kolkata, Ahmedabad all use IST — there is only one time zone in India",
      "Outlook, Google Calendar, and Slack handle DST automatically — but spreadsheets and manual schedules don't",
    ],
    faqs: [
      { q: "What is the time difference between EST and IST?", a: "IST is 10 hours and 30 minutes ahead of EST. When it's 9:00 AM in New York (EST), it's 7:30 PM in India (IST). During US daylight saving (EDT, mid-March to early November), the difference is 9 hours and 30 minutes." },
      { q: "What time is 9 AM EST in India?", a: "9:00 AM EST = 7:30 PM IST (same day). During EDT (US summer), 9:00 AM EDT = 6:30 PM IST. This is a popular meeting slot because it covers the late afternoon in India — still business hours for both teams." },
      { q: "What time is 6 PM IST in EST?", a: "6:00 PM IST = 7:30 AM EST (same day). During EDT, 6:00 PM IST = 8:30 AM EDT. This is the start of the US East Coast business day — useful for India teams wrapping up to brief US colleagues coming online." },
      { q: "Does India observe daylight saving time?", a: "No. India Standard Time (IST) is constant year-round at UTC+5:30. India considered DST during the 1962 China war and again in 2002 but decided against it due to the country's east-west span being small relative to a single time zone." },
      { q: "What is the best meeting time for US East Coast and India teams?", a: "8:30–10 AM EST works best — that's 7:00–8:30 PM IST, still within India business hours. For longer overlap, 8 AM EST gives 6:30 PM IST start. Many US-India teams settle on weekly 9 AM EST / 7:30 PM IST standups." },
      { q: "How do I avoid the DST confusion when scheduling EST–IST meetings?", a: "Always schedule in calendar apps (Outlook, Google Calendar) that auto-adjust for DST — never in a spreadsheet or manual table. Set your home timezone correctly in your OS. Mention the time in both zones in invites: '9:00 AM EST / 7:30 PM IST'." },
      { q: "Is EST the same as EDT?", a: "No. EST (Eastern Standard Time, UTC-5) applies November–March. EDT (Eastern Daylight Time, UTC-4) applies March–November. Most US East Coast residents say 'EST' year-round, but technically the correct abbreviation depends on the date. Calendar apps use 'ET' to mean either." },
      { q: "What cities use EST?", a: "New York, Boston, Philadelphia, Washington D.C., Atlanta, Miami, Toronto, Montreal, Indianapolis, Detroit, Charlotte, and most of the US East Coast and eastern Canada. All shift to EDT in summer." },
    ],
  },
  {
    slug: "timezone",
    ...
    title: "PST to GMT Time Converter (Free)",
    description: "Convert PST to GMT instantly. GMT is 8 hours ahead of PST (7 during US DST). Schedule US West Coast – UK calls. DST handled automatically.",
  ...
  },
  {
    ...
    title: "EST to GMT Time Converter (Free)",
    description: "Convert EST to GMT instantly. GMT is 5 hours ahead of EST (4 during US DST). Plan US East Coast – UK/Europe calls. DST handled automatically.",
  ...
  },
  {
    ...
    title: "kg to lbs Converter (Free + Formula)",
    description: "Convert kilograms to pounds instantly. 1 kg = 2.20462 lbs. Free converter with formula. Use for fitness, shipping, travel, cooking. No signup.",
    ...
    intro: "Convert kilograms to pounds with precision. 1 kilogram equals exactly 2.20462262 pounds — the relationship has been internationally fixed since 1959. This is the most-searched unit conversion worldwide: people use it for body weight (US doctors still record in pounds while most of the world uses kg), luggage limits (airlines publish caps in kg but US passengers think in lbs), gym training (international weightlifting plates are kg, US gym plates are lbs), grocery shopping, shipping, and recipes that mix imperial and metric measurements.",
    tips: [
      "Quick shortcut: multiply kg by 2.2 for a fast approximation (actual factor: 2.20462)",
      "Even faster mental math: double the kg, then add 10% (works to within 0.2 lb up to 100 kg)",
      "Airline luggage limits: most international economy flights allow 23 kg (50.7 lbs) per checked bag, premium 32 kg (70.5 lbs)",
      "Gym plates: a 20 kg plate = 44 lbs, a 25 kg plate = 55 lbs — useful when traveling between metric and imperial gyms",
      "Body weight reference: 60 kg = 132 lbs, 70 kg = 154 lbs, 80 kg = 176 lbs, 90 kg = 198 lbs, 100 kg = 220 lbs",
      "Cooking: 1 kg of flour ≈ 2.2 lbs ≈ 8 cups (recipes from UK/EU often use kg; US recipes use lbs or cups)",
      "Shipping: USPS and UPS price domestic packages by lb, but international by kg — converting affects the rate quoted",
      "Weight class boundaries in boxing/MMA differ between countries — lightweight is 70 kg in WBC but 155 lbs (70.3 kg) in UFC",
    ],
    faqs: [
      { q: "How many pounds is 1 kilogram?", a: "1 kilogram = 2.20462 pounds. To convert kg to lbs, multiply by 2.20462. For example: 70 kg = 154.3 lbs. Quick mental trick: double the kg and add 10% — 70 × 2 = 140, plus 10% (14) = 154." },
      { q: "What is 50 kg in pounds?", a: "50 kg = 110.23 lbs. This is a common conversion for airline checked-baggage limits (most airlines cap economy bags at 23 kg or 32 kg; 50 kg is double the standard allowance and would incur a heavy-bag fee)." },
      { q: "What is 70 kg in pounds?", a: "70 kg = 154.32 lbs. This is the global average adult male body weight and a common reference point in fitness and medicine (drug dosages, BMI charts, weightlifting weight classes)." },
      { q: "What is 100 kg in pounds?", a: "100 kg = 220.46 lbs. A useful reference: 100 kg is the threshold for the heavyweight division in many combat sports, and 220 lbs is roughly the same in pounds — making it an easy mental conversion anchor." },
      { q: "How do I convert pounds back to kilograms?", a: "Divide pounds by 2.20462 (or multiply by 0.45359). Example: 180 lbs ÷ 2.205 = 81.6 kg. Quick trick: halve the pounds, then subtract 10% — 180 ÷ 2 = 90, minus 10% (9) = 81." },
      { q: "Why are kg and lbs both still used?", a: "The US is the only major country that hasn't fully adopted the metric system. Pounds remain in everyday use for body weight, food packaging, and shipping in the US. The rest of the world uses kilograms, but pounds linger in aviation cargo, boxing/MMA, and historical recipes." },
      { q: "Is 1 lb the same as 1 lbs?", a: "Yes — they're the same unit. 'lb' (singular) and 'lbs' (plural) both abbreviate 'pound,' from the Latin 'libra.' Grammatically, '1 lb' is correct and '2 lbs' is plural, but both refer to identical units." },
      { q: "Are pounds the same in the US and UK?", a: "Yes — the international avoirdupois pound (used by both the US and UK) is exactly 0.45359237 kg. However, the UK historically used the 'stone' (14 lbs) for body weight, which the US never adopted. A British person saying '11 stone' means 154 lbs = 70 kg." },
    ],
  },
  {
    slug: "unit-converter",
