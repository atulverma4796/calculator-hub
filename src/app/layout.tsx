...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "15+ free calculators with beautiful charts, PDF export, and multi-currency support. No signup.",
    type: "website",
    locale: "en_US",
    url: SITE_URL,
    siteName: "CalcHub",
  ...
  twitter: {
    ...
    description: "15+ free calculators with interactive charts. EMI, SIP, mortgage, tax, and more.",
  },
  robots: {
    index: true,
    follow: true,
    ...
    >
      ...
      <body className="min-h-full flex flex-col bg-[var(--background)]">
        <JsonLd data={{
          ...
          description: "15+ free online calculators for EMI, SIP, compound interest, mortgage, GST, income tax, BMI, percentage, and more. Interactive charts, multi-currency support. No signup.",
          ...
          featureList: [
            ...
            "BMI Calculator", "Age Calculator", "Tip Calculator", "Fuel Cost Calculator",
          ],
        }} />
        <JsonLd data={{
          "@context": "https://schema.org",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <nav className="hidden md:flex items-center gap-5 text-sm font-medium text-gray-600">
                <Link href="/#financial" className="hover:text-indigo-600 transition-colors">Financial</Link>
                <Link href="/#math" className="hover:text-indigo-600 transition-colors">Math</Link>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div className="col-span-2 md:col-span-1">
                <div className="flex items-center gap-2.5 mb-3">
                  ...
                  <span className="text-lg font-bold text-gray-900">Calc<span className="text-indigo-600">Hub</span></span>
                </div>
              ...
              {/* Financial */}
              <div>
                <h4 className="text-sm font-semibold text-gray-800 mb-3">Financial</h4>
                <nav className="flex flex-col gap-2">
                  {CALCULATOR_LIST.filter(c => c.category === "financial").slice(0, 6).map(c => (
                    <Link key={c.slug} href={`/calculator/${c.slug}`} className="text-sm text-gray-500 hover:text-indigo-600 transition-colors">{c.name}</Link>
                  ))}
                </nav>
              </div>
              ...
              {/* Math & Health */}
              <div>
                <h4 className="text-sm font-semibold text-gray-800 mb-3">Math & Health</h4>
                <nav className="flex flex-col gap-2">
              ...
              {/* Utility */}
              <div>
                <h4 className="text-sm font-semibold text-gray-800 mb-3">Utility</h4>
                <nav className="flex flex-col gap-2">
