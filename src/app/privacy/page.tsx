  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-gray-700 text-sm leading-relaxed">
        <section>
          <h2 className="text-lg font-bold text-gray-900 mt-8 mb-3">Your Data Stays in Your Browser</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mt-8 mb-3">Currency Detection</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mt-8 mb-3">Currency Converter Rates</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mt-8 mb-3">No Accounts or Signup</h2>
          <p>
